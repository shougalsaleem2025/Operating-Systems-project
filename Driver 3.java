...
public class Driver {
	  ...
	  public static List<PCB> q1 =  new ArrayList<>();
     public static List<PCB> q2 =  new ArrayList<>();
     public static int currentTime = 0;
     public static int NotEnd = 0; 
      ...
      try (Scanner scanner = new Scanner(System.in)) {
         while (true) {
            ...
            switch (choice) {
               ...
               addProcess("P"+(i+1),priority, arrivalTime, cpuBurst);
               }
               break;
               case 2:
   ...
   public static void addProcess(String processID, int priority, int arrivalTime, int cpuBurst) {
      ...
      public static String calculateAverages(List<PCB> scheduleOrder) {
